...
- Typically only granted to administrators.
- The other external tool privileges include EDIT*EXTERNAL_TOOL and DELETE* EXTERNAL_TOOL.
...
- Typically only granted to administrators.
- The other external tool privileges include CREATE*EXTERNAL_TOOL and EDIT* EXTERNAL_TOOL.
...
- Typically only granted to administrators.
- The other external tool privileges include CREATE*EXTERNAL_TOOL and DELETE* EXTERNAL_TOOL.
...
- Typically only granted to administrators.
- The other advanced search privileges include CREATE*POWER_SEARCH, DELETE* POWER_SEARCH and SEARCH_POWER_SEARCH.
...
- Other dynamic collection privileges include CREATE*DYNA_COLLECTION, DELETE_DYNA_COLLECTION, EDIT* DYNA_COLLECTION and VIEW_DYNA_COLLECTION.
...
- The other remote repository privileges are CREATE*FEDERATED_SEARCH, DELETE* FEDERATED_SEARCH and EDIT_FEDERATED_SEARCH.
...
- The other advanced search privileges are CREATE*POWER_SEARCH, DELETE* POWER_SEARCH and EDIT_POWER_SEARCH.
