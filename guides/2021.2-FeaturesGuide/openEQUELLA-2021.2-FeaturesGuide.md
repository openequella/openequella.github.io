# openEQUELLA 2021.2 Features Guide

## Table of Contents
* [Search mode](#search-mode)
* [DRM enhancements](#drm-enhancements)
* [Previewing YouTube and Kaltura media](#previewing-youtube-and-kaltura-media)
* [Lightbox enhancements](lightbox-enhancements)
  * [Accessing the Resource summary page](#accessing-the-resource-summary-page)
  * [Copying embed codes](#copying-embed-codes)
* [Gallery navigation](#gallery-navigation)
* [Advanced search](#advanced-search)
  * [Advanced search wizard controls](#advanced-search-wizard-controls)
  * [Visibility scripting](#visibility-scripting)
...
# Previewing YouTube and Kaltura media
...
Edalex will deprecate support for Zookeeper versions earlier than 3.5.x from openEQUELLA 2022.1. It is advised that institutions on versions earlier than 3.5.x upgrade to the latest version of Zookeeper at their earliest convenience.
